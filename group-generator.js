...
const loadAttendanceData = () => {
    ...
    // Hentikan render jika tidak ada perubahan data inti
...
const initializeChart = (stats, rootElement) => {
    ...
    // Chart global variable should be available via CDN import
...
export const renderAttendanceComponent = () => {
    ...
    // Cek ketersediaan Chart
    if (typeof Chart !== 'undefined') {
        initializeChart(stats, rootElement);
    } else {
        console.error("Chart.js is not loaded. Please ensure the library is imported before this script.");
    }
};
